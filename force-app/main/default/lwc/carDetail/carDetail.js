...
export default class CarDetail extends LightningElement {
    ...
    carExperienceAddedHandler() {
        const carExperiencesComponent = this.template.querySelector('c-car-experiences');
        if (carExperiencesComponent) {
            carExperiencesComponent.getCarExperiences();

            this.selectedTabValue = 'viewexperiences';
        }
    }
